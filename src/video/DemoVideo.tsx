...
function Intro() {
  ...
  const frame = useCurrentFrame();
  // Counts a real 0.0 -> 8.0s across the full 240-frame (8s @30fps) intro, so it
  // hits 8.0 exactly as we cut to screen 2 on the music's swell.
  const timer = interpolate(frame, [0, 240], [0, 8], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
  return (
    <AbsoluteFill>
